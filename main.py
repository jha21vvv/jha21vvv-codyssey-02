...
class QuizGame:
    ...
    def load_data(self):
        try:
            ...
            self.quizzes = [
                Quiz("고양이는 어떻게 울까?", ["고양고양", "미야오미야오", "니코니코", "거참 뭘 자꾸 건드리소!!!"], 4, "전라도산 고양이다"),
                Quiz("강아지는 어떻게 울까?", ["멍멍", "바쿠바쿠", "왕왕", "거울수도있지"], 4, "자의식이 강한 강아지다"),
                Quiz("병아리는 어떻게 울까?", ["삐약삐약", "치킨 바나나 치킨 바나나", "오이 도데모 이다로", "후라이드반 양념반"], 2, "어머니는 양념을 조아하신다"),
                Quiz("오랑우란은 뭐라고 하나?", ["바나나 한개에 한대 깎아준다", "이참에 폰 바꾸시죠", "손님 맞고 싶어요", "어디까지알아시고 오셨나요?"], 1, "양아치"),
                Quiz("학은 뭐라고 울까?", ["하하하학", "학학학", "헉헉헉", "학씨마!!!"], 4, "제주도 출신이시다")
            ]
